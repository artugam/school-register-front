...
function DashboardNavigation(data){
        ...
        <nav className="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white">
            <div className="container-fluid">
                ...
                <a className="navbar-brand pt-0" href="/dashboard">
                    {/*<img src="../assets/img/urlogo.png" className="navbar-brand-img" alt="..."></img>*/}
                    {/*<img src={require('../assets/img/urlogo.png')} className="navbar-brand-img" alt="..."></img>*/}
                    ...
                    <ul className="navbar-nav">
                        <li className="nav-item active ">
                            <a className=" nav-link active " href=" ./index.html"> <i
                                className="ni ni-tv-2 text-primary"></i> Dashboard
                            </a>
                        </li>
