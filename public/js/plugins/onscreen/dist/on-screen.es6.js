 ...
 * @param {function} callback The callback globalFunctions to handle the event
 * @return {void}
 */
...
/**
 * Observes DOM mutations and runs a callback globalFunctions when
 * detecting one.
 *
 * @param {node} obj The DOM node you want to observe
 * @param {function} callback The callback globalFunctions you want to call
 * @return {void}
 */
